...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center px-3 sm:px-6">
        ...
        <div className="flex md:hidden items-center gap-2 sm:gap-4 shrink-0">
          <button
            ...
            className={`p-1.5 sm:p-2 rounded-xl transition-colors ${open ? "text-gray-900" : textColor}`}
      ...
      {/* Mobile Menu */}
      <div
        className={`md:hidden absolute top-full left-0 w-full bg-white shadow-2xl transition-all duration-300 origin-top overflow-hidden ${
      ...
      >
        <div className="flex flex-col p-6 gap-6 overflow-y-auto">
          ...
          <div className="pt-4 border-t border-gray-100 flex flex-col gap-4">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-widest pl-1">Preferences</p>
            <div className="w-full">
              <LanguageTranslator uniqueId="translator-mobile" />
            </div>
            <button
              onClick={() => {
                setSearchOpen(true);
              ...
              className="flex items-center gap-3 px-4 py-3 bg-gray-50 rounded-2xl text-primary font-heading font-bold hover:bg-gray-100 transition-colors"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
